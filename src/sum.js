...
while(Number.isNaN(lowerBound)|| Number.isNaN(upperBound)|| !Number.isInteger(lowerBound)|| !Number.isInteger(upperBound) || !Number.MIN_SAFE_INTEGER>lowerBound||lowerBound>Number.MAX_SAFE_INTEGER|| Number.MIN_SAFE_INTEGER > upperBound||upperBound > Number.MAX_SAFE_INTEGER ){
